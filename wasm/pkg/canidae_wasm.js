...
export function init_canidae() {
    const ret = wasm.init_canidae();
    if (ret[1]) {
...
const PackClientFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_packclient_free(ptr >>> 0, 1));
...
export class PackClient {
    ...
    __destroy_into_raw() {
        ...
        this.__wbg_ptr = 0;
        PackClientFinalization.unregister(this);
        return ptr;
    }

    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_packclient_free(ptr, 0);
    }
    /**
     ...
     * @param {string} ws_url
     */
    constructor(pack_id, member_id, ws_url) {
        const ptr0 = passStringToWasm0(pack_id, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ptr1 = passStringToWasm0(member_id, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len1 = WASM_VECTOR_LEN;
        const ptr2 = passStringToWasm0(ws_url, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len2 = WASM_VECTOR_LEN;
        const ret = wasm.packclient_new(ptr0, len0, ptr1, len1, ptr2, len2);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        this.__wbg_ptr = ret[0] >>> 0;
        PackClientFinalization.register(this, this.__wbg_ptr, this);
        return this;
    }
    connect() {
        const ret = wasm.packclient_connect(this.__wbg_ptr);
        if (ret[1]) {
            throw takeFromExternrefTable0(ret[0]);
        }
    }
    ...
    send_message(content) {
        ...
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.packclient_send_message(this.__wbg_ptr, ptr0, len0);
        if (ret[1]) {
            throw takeFromExternrefTable0(ret[0]);
        }
    }
    disconnect() {
        wasm.packclient_disconnect(this.__wbg_ptr);
    }
    /**
     * @returns {boolean}
     */
    is_connected() {
        const ret = wasm.packclient_is_connected(this.__wbg_ptr);
        return ret !== 0;
    }
    /**
     * @returns {string}
    ...
    get_pack_id() {
        ...
        let deferred1_1;
        try {
            const ret = wasm.packclient_get_pack_id(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
            return getStringFromWasm0(ret[0], ret[1]);
        } finally {
    ...
    get_member_id() {
        ...
        let deferred1_1;
        try {
            const ret = wasm.packclient_get_member_id(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
            return getStringFromWasm0(ret[0], ret[1]);
        } finally {
    ...
    set_message_callback(callback) {
        wasm.packclient_set_message_callback(this.__wbg_ptr, callback);
    }
    /**
     * @param {Function} callback
     */
    set_error_callback(callback) {
        wasm.packclient_set_error_callback(this.__wbg_ptr, callback);
    }
}
...
function __wbg_get_imports() {
    ...
    imports.wbg.__wbg_log_add33ae5b977865d = function(arg0, arg1) {
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('canidae_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
